            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  <span className="px-2 py-0.5 bg-purple-100 text-purple-800 text-[11px] md:text-[10px] uppercase rounded font-semibold md:font-black border border-purple-200 tracking-wide md:tracking-wider w-[calc(50%-0.25rem)] sm:w-auto text-center">家族旅遊</span>
                </div>
              </div>
          ...
          <div className="flex flex-wrap gap-2 mb-6 no-print">
            {hotels.map((hotel) => (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-sm font-black transition-all ${selectedHotelId === hotel.id
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
      {items.map((item) => {
        ...
        return (
          <label
            key={item.id}
            className={`flex items-center gap-2 text-sm font-bold rounded-lg border px-3 py-2 transition ${checked
  ...
  <div className="p-6 md:p-10 space-y-8 bg-indigo-50 print-break-inside-avoid">
    ...
    <div className="max-w-3xl mx-auto bg-white p-6 rounded-2xl border-2 border-indigo-200 shadow-sm print-break-inside-avoid">
      ...
      <ul className="text-sm text-slate-700 space-y-3 font-bold leading-[1.6] tracking-wide md:tracking-normal">
        ...
        <li className="flex gap-2 items-start"><span className="text-indigo-600">3.</span> <div><strong>行李上鎖戰略：</strong>坐位子上可能看不到車廂前後的公共行李架。上車後請務必用大創買的「自行車鋼絲鎖」把三個行李跟鐵桿鎖在一起！</div></li>
      </ul>
    </div>
...
const ItineraryView = () => {
  ...
  const ItineraryData = [
    {
      day: 1, date: "06/12 (五)", city: "台北 ➔ 杜拜", title: "旅遊啟動：旗艦機體驗", hotel: "機上 (阿聯酋航空 A380)",
      events: [
    ...
    },
    {
      ...
      events: [
        ...
        { time: "16:40", icon: <Bed size={16} />, desc: "【無痛入住】步行抵達 Hotel Midway，進房休息", type: "highlight" },
    ...
    },
    {
      ...
      events: [
        ...
        { time: "17:00", icon: <Bed size={16} />, desc: "入住 Plus Florence，午休充電", type: "highlight" },
    ...
    },
    {
      ...
      events: [
        ...
        { time: "14:30", icon: <Bed size={16} />, desc: "入住 Hotel Milani，進房午休躲烈日", type: "highlight" },
    ...
    },
    {
      ...
      events: [
        ...
        { time: "14:00", icon: <Bed size={16} />, desc: "回飯店睡午覺，儲備下午電力", type: "info" },
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-6 md:p-8 rounded-2xl shadow-lg mb-8 relative print-break-inside-avoid">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-black mb-2 leading-tight">義大利 15 天旅遊</h1>
            <p className="text-slate-200 text-sm md:text-base font-bold leading-[1.6] tracking-wide md:tracking-normal">2026.06.12 (Fri) - 06.26 (Fri) · 家族旅遊</p>
                        ...
                        <section className="print-break-inside-avoid">
                          <div className="bg-emerald-50 p-5 rounded-lg border-l-4 border-emerald-500 mt-4">
                            <h4 className="font-black text-emerald-900 flex items-center gap-2">
                              <Navigation size={18} /> 家族旅遊 3 大安全戰略
                            </h4>
                            <ul className="list-decimal pl-5 mt-2 text-sm text-emerald-800 space-y-2 font-bold">
                              ...
                              <li><strong>結伴行動：</strong> 在車站、觀光景點人潮擁擠處，請家人務必走在您的視線範圍內前方，不要殿後。</li>
                            </ul>
                          </div>
                        </section>
                      </div>
                      ...
                      <div className="p-4 md:p-8 space-y-8 bg-[#FFFBF0] print-break-inside-avoid">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-amber-200 shadow-sm print-break-inside-avoid">
                          ...
                          <ul className="space-y-4">
                            <CheckItem item="Mulino Bianco 開心果夾心餅乾" desc="白磨坊綠色包裝 (Baiocchi)，極度熱賣，濃郁不甜膩，全家都會喜歡。" />
                    ...
                    const TabButton = ({ id, label, active, set, color }) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span
                            className={`absolute left-3 right-3 bottom-1 h-0.5 rounded-full transition-all duration-300 ${active === id ? 'opacity-100 scale-x-100 bg-current' : 'opacity-0 scale-x-0 bg-current'
                              }`}
                          />
                        </button>
                      );
